package bg.softuni.flowerDeliver.util;

import bg.softuni.flowerDeliver.domain.dto.view.OrderViewDto;
import bg.softuni.flowerDeliver.domain.entities.*;
...
import bg.softuni.flowerDeliver.repositories.*;
...
public class TestDataUtils {
    ...
    public ProductEntity createProductBurger(String name) {
        ...
        ProductEntity product = new ProductEntity()
                .setPrice(BigDecimal.TEN)
                .setName(name)
                .setCategory(ProductCategoryEnum.flower)
    ...
    public ProductEntity createProductPizza(String name) {
        ...
        ProductEntity product = new ProductEntity()
                .setPrice(BigDecimal.TEN)
                .setName(name)
                .setCategory(ProductCategoryEnum.basket)
                .setDescription("description product");
