...
public class FlowerDeliverUserDetailsServiceTest {

    @Mock
    private UserRepository mockUserRepository;

    private FlowerDeliverUserDetailsService serviceToTest;

    @BeforeEach
    void setUp() {
        serviceToTest = new FlowerDeliverUserDetailsService(mockUserRepository);
    }
