package bg.softuni.flowerDeliver.domain.dto.binding;

import bg.softuni.flowerDeliver.domain.enums.GenderEnum;
import bg.softuni.flowerDeliver.validation.common.ValidEmail;
import bg.softuni.flowerDeliver.validation.common.ValidPersonName;
import bg.softuni.flowerDeliver.validation.common.ValidPhoneNumber;
import bg.softuni.flowerDeliver.validation.user.*;
import jakarta.persistence.*;
import jakarta.validation.constraints.*;

import static bg.softuni.flowerDeliver.constants.ValidationErrorMessages.*;
